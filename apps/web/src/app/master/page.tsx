import { getSuggestions } from "@takt/db";
import { Workbench } from "@/components/app/Workbench";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Master mode: no product selected. Takt searches across every product at once
...
export default function MasterWorkbench() {
  ...
  return <Workbench slug={null} productName="Takt" starters={starters.length ? starters : undefined} />;
}
