...
// The Takt live mark: a lit orb with a five-bar waveform CARVED into it. ONE
// component everywhere: the animated in-call orb and the small status marks
// (idle pulse).
//
...
export function LiveOrb({ phase = "idle", getLevels, getBands, size = 240, pulse = false }: {
  phase?: LivePhase;
