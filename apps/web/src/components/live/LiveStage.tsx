...
// and the on-device model download. The in-call UI lives in LiveDock/InCall.
          ...
          {models.map((m) => {
            ...
            return (
              <li key={m.key} className="flex items-center gap-2 text-[11px]">
                <span className={cn("grid size-3.5 shrink-0 place-items-center rounded-full text-[8px]", done ? "bg-accent text-white" : "border border-border text-transparent")}>✓</span>
    ...
    <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-y-auto">
      <div className="m-auto flex w-full max-w-sm flex-col items-center gap-4 px-6 py-6 text-center">
        ...
        {downloading ? (
          ...
          <div className="flex flex-col items-center gap-2">
            <button onClick={onDownload} className="rounded-full bg-accent px-6 py-2.5 text-[14px] font-medium text-white transition duration-150 hover:scale-[1.03] hover:opacity-90 active:scale-95">
              Download AI models
            </button>
          ...
          <button onClick={onStart} className="rounded-full bg-accent px-7 py-2.5 text-[14px] font-medium text-white transition duration-150 hover:scale-[1.03] hover:opacity-90 active:scale-95">
            Start
          </button>
        )}
