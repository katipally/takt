...
assert.deepEqual(lintArtifact('<div class="takt-doc"><p>Shade 10 helmet [p.18].</p><figure class="takt-figure"><img src="/assets/crops/x.png"/></figure></div>'), [], "clean artifact passes");
// each bad pattern is caught
assert.ok(lintArtifact('<div class="takt-crop"><img src="/assets/x.png"/></div>').includes("css-crop"), "css-crop caught");
...
assert.ok(lintArtifact('<div class="takt-callout">[p.18]</div>').includes("boxed-citation"), "boxed citation caught");
